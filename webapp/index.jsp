...
<body>
    <h1>メインメニュー</h1>
        <ul>
            <li><a href="product-list" class="menu-button btn-jewelry">💍 ジュエリー制作物一覧 💍</a></li>
            <li><a href="gem-list" class="menu-button btn-loose">💎 ルース在庫 💎</a></li>
            <li><a href="item-entry" class="menu-button btn-create">✨ 新しく製品を作る ✨</a></li>
        </ul>
</body>
</html>